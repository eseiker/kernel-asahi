...
%global __mod_compress_install_post find %{buildroot}/lib/modules -type f -name \*.ko -print0 | xargs -0 -n 16 -r -P ${RPM_BUILD_NCPUS} xz --compress --check=crc32 --lzma2=dict=1MiB
...
popd
pushd tools/arch/x86/intel_sdsi
%{make_tools} CFLAGS="%{?build_cflags}" DESTDIR=%{buildroot} BINDIR=%{_sbindir} install
popd
%endif
...
%changelog
* Mon Feb 16 2026 Kmods SIG <sig-kmods@centosproject.org> - 6.18.11-1
- Update to 6.18.11

* Thu Feb 12 2026 Kmods SIG <sig-kmods@centosproject.org> - 6.18.10-1
- Update to 6.18.10

* Sat Feb 07 2026 Kmods SIG <sig-kmods@centosproject.org> - 6.18.9-1
- Update to 6.18.9

* Sat Jan 31 2026 Kmods SIG <sig-kmods@centosproject.org> - 6.18.8-1
- Update to 6.18.8

* Sat Jan 24 2026 Kmods SIG <sig-kmods@centosproject.org> - 6.18.7-1
- Update to 6.18.7

* Sun Jan 18 2026 Kmods SIG <sig-kmods@centosproject.org> - 6.18.6-1
- Update to 6.18.6

* Mon Jan 12 2026 Kmods SIG <sig-kmods@centosproject.org> - 6.18.5-1
- Update to 6.18.5
...
* Sat Dec 13 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.17.12-1
- Update to 6.17.12

* Sun Dec 07 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.17.11-1
- Update to 6.17.11

* Tue Dec 02 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.17.10-1
- Update to 6.17.10

* Tue Nov 25 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.17.9-1
- Update to 6.17.9

* Fri Nov 14 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.17.8-1
- Update to 6.17.8

* Mon Nov 03 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.17.7-1
- Update to 6.17.7

* Thu Oct 30 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.17.6-1
- Update to 6.17.6

* Fri Oct 24 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.17.5-1
- Update to 6.17.5

* Mon Oct 20 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.17.4-1
- Update to 6.17.4
...
* Tue Oct 07 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.16.11-1
- Update to 6.16.11

* Fri Oct 03 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.16.10-1
- Update to 6.16.10

* Fri Sep 26 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.16.9-1
- Update to 6.16.9

* Fri Sep 19 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.16.8-1
- Update to 6.16.8

* Fri Sep 12 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.16.7-1
- Update to 6.16.7

* Wed Sep 10 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.16.6-1
- Update to 6.16.6

* Fri Sep 05 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.16.5-1
- Update to 6.16.5

* Thu Aug 28 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.16.4-1
- Update to 6.16.4

* Sun Aug 24 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.16.3-1
- Update to 6.16.3
...
* Sat Aug 16 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.15.10-1
- Update to 6.15.10
...
* Thu Jul 24 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.15.8-1
- Update to 6.15.8

* Fri Jul 18 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.15.7-1
- Update to 6.15.7

* Fri Jul 11 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.15.6-1
- Update to 6.15.6

* Mon Jul 07 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.15.5-1
- Update to 6.15.5

* Fri Jun 27 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.15.4-1
- Update to 6.15.4
...
* Thu Jun 05 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.14.10-1
- Update to 6.14.10

* Fri May 30 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.14.9-1
- Update to 6.14.9

* Fri May 23 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.14.8-1
- Update to 6.14.8

* Sun May 18 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.14.7-1
- Update to 6.14.7

* Sat May 10 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.14.6-1
- Update to 6.14.6

* Fri May 02 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.14.5-1
- Update to 6.14.5

* Fri Apr 25 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.14.4-1
- Update to 6.14.4

* Mon Apr 21 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.14.3-1
- Update to 6.14.3

* Tue Apr 15 2025 Peter Georg <peter.georg@physik.uni-regensburg.de> - 6.14.2-1
- Update to 6.14.2

* Fri Apr 11 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.13.11-1
- Update to 6.13.11

* Tue Apr 08 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.13.10-1
- Update to 6.13.10

* Sat Mar 29 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.13.9-1
- Update to 6.13.9

* Sun Mar 23 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.13.8-1
- Update to 6.13.8

* Thu Mar 13 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.13.7-1
- Update to 6.13.7

* Fri Mar 07 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.13.6-1
- Update to 6.13.6

* Thu Feb 27 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.13.5-1
- Update to 6.13.5

* Fri Feb 21 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.13.4-1
- Update to 6.13.4

* Tue Feb 18 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.13.3-1
- Update to 6.13.3

* Sat Feb 08 2025 Kmods SIG <sig-kmods@centosproject.org> - 6.13.2-1
- Update to 6.13.2
